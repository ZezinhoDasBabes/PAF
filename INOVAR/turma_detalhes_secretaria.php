...
if (isset($_GET['id'])) {
    ...
    // Consulta para pegar os alunos da turma, ordenados por nome
    $stmt_alunos = $conn->prepare("SELECT id, nome, avatar FROM alunos WHERE turma = (SELECT nome FROM turmas WHERE id = ?) ORDER BY nome ASC");
