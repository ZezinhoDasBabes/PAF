...
$stmt = $conn->prepare("SELECT id, nome, senha, turma, nif, nascimento, nacionalidade, email, morada FROM alunos WHERE nome = ? LIMIT 1");
...
<body>
    <div class="container">
        ...
        <p><strong>Turma:</strong> <?php echo $user_info['turma']; ?></p>
        <div class="password-container">
            ...
            <a href="mudar_senha_aluno.php" class="btn btn-yellow">Mudar Senha</a> <!-- Botão para mudar senha -->
        </div>
        <p><strong>Email:</strong> <?php echo $user_info['email']; ?></p>
        <p><strong>NIF:</strong> <?php echo $user_info['nif']; ?></p>
        <p><strong>Nacionalidade:</strong> <?php echo $user_info['nacionalidade']; ?></p>
        <p><strong>Morada:</strong> <?php echo $user_info['morada']; ?></p>
